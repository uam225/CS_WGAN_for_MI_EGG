...
class DCGAN:
    def __init__(self, channels=3, batchsize=50, noise_dim=100, feature_dim=10):
        ...
        self.optimiser_G = optim.Adam(self.generator.parameters(), lr=0.0002, betas=(0.9, 0.999)) #defaults: lr = 0.0002, betas=(0.5, 0.999)
        self.optimiser_D = optim.Adam(self.discriminator.parameters(), lr=0.0001, betas=(0.9, 0.999)) #defaults: lr = 0.0002, betas=(0.5, 0.999)
